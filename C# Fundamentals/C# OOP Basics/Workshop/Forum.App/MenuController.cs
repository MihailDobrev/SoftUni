namespace Forum.App
{
    ...
    internal class MenuController
    {
        ...
        private void RedirectToAddReply()
        {
            ...
            addReplyController.SetPostId(postDetailsController.PostId,this.Username);
        ...
        private void OpenCategory()
        {
            ...
            int categoryIndex = categoriesController.CurrentPage * CategoryController.PAGE_OFFSET + this.currentOptionIndex;
