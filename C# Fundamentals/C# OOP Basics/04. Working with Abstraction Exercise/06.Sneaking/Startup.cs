namespace _06.Sneaking
{
    ...
    public class Startup
    {
        public static void Main()
        {
            ...
            {
                room = EnemiesMakeMoves(moves, room);
                int[] getEnemy = FindEnemyPosition(room, samPosition);
                CheckIfSamDies(room, getEnemy, samPosition);
                ...
                CheckIfNikoladzeIsKilled(room, getEnemy, samPosition);
            }
        }

        private static void CheckIfNikoladzeIsKilled(char[][] room, int[] getEnemy, int[] samPosition)
        {
        ...
        private static void CheckIfSamDies(char[][] room, int[] getEnemy, int[] samPosition)
        {
        ...
        private static int[] FindEnemyPosition(char[][] room, int[] samPosition)
        {
        ...
        private static char[][] EnemiesMakeMoves(char[] moves, char[][] room)
        {
            for (int row = 0; row < room.Length; row++)
            {
                for (int col = 0; col < room[row].Length; col++)
        ...
        private static char[][] FillRoom(int n)
        {
            var room = new char[n][];
